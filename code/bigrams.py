bigrams = [
    ...
    (r"covid ?outbreaks?", "covidoutbreak"),
    ...
    (r"record ?highs?", "recordhigh"),
    (r"record ?lows?", "recordlow"),
    (r"open ?borders?", "openborder"),
    (r"worst ?years? ?ever", "worstyearever"),
    ...
    (r"fear ?campaigns?", "fear_campaign"),  
    ...
    (r"north ?korean?", "northkorea"),
    (r"over the border", "overtheborder"),
    (r"supress ?t?h?e? ?voter?s?", "votersuppression"),
    ...
    (r'voter? ?supression', 'votersuppression'),
    ...
    (r"be civil", "becivil"),
    (r"civil ?cases?", "civilcase"),
    (r"electoral college", "electoralcollege"),
    (r"electoral ?votes?", "electoralvotes"),
    (r"russian interference", "russianinterference"),
    (r"foreign interference", "foreigninterference"),    
    ...
    (r"voti?n?g?e?r? ?rights?", "votingrights"),
    (r"wwgwga", "wwg1wga"),
    ...
    (r"democratic ?presidential ?nominees?", "democraticpresidentialnominee"),
    (r"republican ?presidential ?nominees?", "republicanpresidentialnominee"),
    ...
    (r"cut ?taxe?s?", "reducetax"),
    (r"reduce ?taxe?s?", "reducetax"),
    (r"tax ?records?", "taxrecords"),
    (r"tax ?breaks?", "taxbreaks"),
    (r"rich people", "richpeople"),
    (r"poor people", "poorpeople"),
    ...
    (r"mail ?in ?ballots?", "mailinballot"),
